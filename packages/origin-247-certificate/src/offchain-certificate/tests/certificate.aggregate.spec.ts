...
describe('CertificateAggregate', () => {
    describe('creation', () => {
        ...
        it('should create aggregate from certificateReadModel', () => {
            const aggregate = CertificateAggregate.fromReadModel(certificateReadModel);
            expect(aggregate.getCertificate()).toMatchObject(certificateReadModel);
        });
    });
